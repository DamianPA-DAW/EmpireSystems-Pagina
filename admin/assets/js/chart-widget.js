...
(function () {
      ...
      xaxis: [
        {
          ...
          label: {
            ...
            style: {
              color: "#fff",
              background: GoloAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsuserchart = {
    ...
    colors: [GoloAdminConfig.primary, GoloAdminConfig.secondary, "#0dbe54", "#b52af6"],
    title: {
  ...
  var optionsColumn = {
    ...
    shared: true,
      marker: {
        fillColors: ['#54A8FB'], // Set custom colors for each series
      },
    },
  ...
  var optionsCircle = {
    ...
    colors: [GoloAdminConfig.secondary, GoloAdminConfig.primary, "#0dbe54"],
    responsive: [
      {
        breakpoint: 767,
        options: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [GoloAdminConfig.primary],
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [GoloAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
