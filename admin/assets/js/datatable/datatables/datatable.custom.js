(function ($) {
  $(document).ready(function () {
    ...
    $("#topseller-table").DataTable({
      ...
      //   $('.paginate_button.first, .paginate_button.last').remove();
      // }
    });

    // recentseller

    $("#recentseller-table").DataTable({
      columnDefs: [
        {
          orderable: false,
          render: $.fn.dataTable.render.select(),
