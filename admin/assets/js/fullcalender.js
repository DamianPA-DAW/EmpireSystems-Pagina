...
var FullCalendar = (function (exports) {
  ...
  function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
    var def = {
      ...
      ...__assign(__assign({}, refined.extendedProps || {}), extra),
    };
  ...
  var EventApi = /** @class */ (function () {
    ...
    Object.defineProperty(EventApi.prototype, 'subTitle', {
      get: function () {
        return this._def.subTitle;
      },
      enumerable: false,
      configurable: true,
    });
    Object.defineProperty(EventApi.prototype, 'image', {
      get: function () {
        return this._def.image;
      },
      enumerable: false,
      configurable: true,
    });
    Object.defineProperty(EventApi.prototype, 'task', {
      get: function () {
        return this._def.task;
      },
      enumerable: false,
      configurable: true,
    });
    Object.defineProperty(EventApi.prototype, 'hours', {
      get: function () {
        return this._def.hours;
      },
      enumerable: false,
      configurable: true,
    });
    ...
    EventApi.prototype.toPlainObject = function (settings) {
      ...
      if (def.subTitle) {
        res.subTitle = def.subTitle;
      }
      if (def.imaege) {
        res.imaege = def.imaege;
      }
      if (startStr) {
        res.start = startStr;
      }
      ...
      for (var optionName in raw) {
        if (raw[optionName] === currentRaw[optionName] || (COMPLEX_OPTION_COMPARATORS[optionName] && COMPLEX_OPTION_COMPARATORS[optionName](raw[optionName], currentRaw[optionName]))) {
          ...
          if (
            ...
            (COMPLEX_OPTION_COMPARATORS[optionName] && COMPLEX_OPTION_COMPARATORS[optionName](raw[optionName], this.currentCalendarOptionsInput[optionName]))
          ) {
  ...
  var ViewContainer = /** @class */ (function (_super) {
    ...
    ViewContainer.prototype.render = function () {
      ...
      return createElement(
        'div',
        { 'aria-labelledby': props.labeledById, ref: this.handleEl, className: classNames.join(' '), style: { height: height, paddingBottom: paddingBottom } },
        props.children,
      );
    };
  ...
  var TableDateCell = /** @class */ (function (_super) {
    ...
    TableDateCell.prototype.render = function () {
      ...
      return createElement(
        ...
        function (rootElRef, customClassNames, innerElRef, innerContent) {
          var nameM = innerContent.split(' ')[0];
          var dateM = innerContent.split(' ')[1];
            ...
            createElement(
              ...
              !dayMeta.isDisabled &&
                createElement(
                  ...
                  createElement('span', { className: 'dayName' }, nameM),
                  dateM,
                ),
            ),
          );
        ...
        function (rootElRef, customClassNames, innerElRef, innerContent) {
          return createElement(
            ...
            createElement(
              ...
              createElement(
                'a',
                { 'aria-label': dateEnv.format(date, WEEKDAY_FORMAT), className: ['fc-col-header-cell-cushion', props.isSticky ? 'fc-sticky' : ''].join(' '), ref: innerElRef },
                innerContent,
              ),
            ),
          );
  ...
  function renderInnerContent$4(innerProps) {
    return createElement(
      ...
      createElement(
        ...
        createElement('img', { src: innerProps.event.image, alt: innerProps.event.title }),
        createElement(
          'div',
          { className: 'fc-event-title-container' },
          createElement('div', { className: 'fc-event-title fc-sticky' }, innerProps.event.title),
          createElement('div', { className: 'fc-event-subtitle fc-sticky' }, innerProps.event.subTitle),
        ),
      ),
      createElement(
        'div',
        { className: 'fc-task-box fc-sticky' },
        createElement('div', { className: 'fc-task-text-box' }, createElement('span', { className: 'fc-task-text' }, innerProps.event.task), 'task'),
        createElement('div', { className: 'fc-task-text-box' }, createElement('span', { className: 'fc-task-text' }, innerProps.event.hours), 'Hours'),
      ),
  ...
  function renderInnerContent$3(props) {
    ...
    var subTitle = props.event.subTitle;
    return title && createElement('div', { className: 'fc-event-title' }, props.event.title) && subTitle && createElement('div', { className: 'fc-event-subTitle' }, props.event.subTitle);
  }
      ...
      return createElement(
        ...
        function (rootElRef, classNames, innerElRef, innerContent, handleClick, title, isExpanded, popoverId) {
          return createElement(
            'a',
            __assign(
              { ref: rootElRef, className: ['fc-daygrid-more-link'].concat(classNames).join(' '), title: title, 'aria-expanded': isExpanded, 'aria-controls': popoverId },
      ...
      _this.renderHeadAxis = function (rowKey, frameHeight) {
        ...
        if (options.weekNumbers && rowKey === 'day') {
          return createElement(WeekNumberRoot, { date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, function (rootElRef, classNames, innerElRef, innerContent) {
            return createElement(
              'th',
              { ref: rootElRef, 'aria-hidden': true, className: ['fc-timegrid-axis', 'fc-scrollgrid-shrink'].concat(classNames).join(' ') },
              createElement(
                'div',
