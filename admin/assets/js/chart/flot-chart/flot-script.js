(function ($) {
  ...
  if ($("#flot-basic-chart").length > 0) {
    ...
    $.plot("#flot-basic-chart", [a, c, d], {
      ...
      colors: ["#0dbe54", "#0dbe54", "#0dbe54", "#0dbe54"],
    });
  }
  ...
  function plotAccordingToChoices() {
    ...
    if (data.length > 0) {
      $.plot("#toggling-series-flot", data, {
        ...
        colors: [GoloAdminConfig.primary, "#F8AA4B", "#a927f9", "#0dbe54", GoloAdminConfig.secondary, "#AF76F2", "#F8AA4B"],
      });
    }
  }
...
$(function () {
  ...
  var data = [
    { color: "#AF76F2", points: data1_points, data: data1, label: "data1" },
    ...
    { color: "#0dbe54", points: data3_points, data: data4_errors },
  ];
...
$(function () {
  ...
  $.plot("#default-pie-flot-chart", data, {
    ...
    colors: [GoloAdminConfig.primary, "#0dbe54", "#F8AA4B", "#a927f9", "#AF76F2", "#6c757d", GoloAdminConfig.secondary],
  });
