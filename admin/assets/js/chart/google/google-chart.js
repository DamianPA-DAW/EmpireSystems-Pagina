  ...
  function drawBasic() {
    if ($("#column-chart1").length > 0) {
      var a = google.visualization.arrayToDataTable([
        ...
        b = {
          ...
          height: 400,
          width: "100%",
          colors: [GoloAdminConfig.primary, GoloAdminConfig.secondary, "#0dbe54"],
        },
    ...
    if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#F8AA4B", "#0dbe54", "#a927f9", GoloAdminConfig.secondary, GoloAdminConfig.primary],
      };
    ...
    if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#F8AA4B", "#a927f9", "#0dbe54", GoloAdminConfig.secondary, GoloAdminConfig.primary],
      };
    ...
    if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        colors: ["#AF76F2", GoloAdminConfig.primary, GoloAdminConfig.secondary, "#0dbe54", "#a927f9", "#F8AA4B", "#AF76F2", GoloAdminConfig.primary, "#F8AA4B", "#0dbe54", GoloAdminConfig.primary, GoloAdminConfig.secondary, "#0dbe54", GoloAdminConfig.primary, "#a927f9", "#F8AA4B", GoloAdminConfig.primary, GoloAdminConfig.primary, "#a927f9", GoloAdminConfig.secondary, GoloAdminConfig.primary, "#0dbe54"],
      };
    ...
    if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width: "100%",
        colors: [GoloAdminConfig.primary, GoloAdminConfig.secondary, "#0dbe54", "#a927f9", "#F8AA4B"],
      };
    ...
    if ($("#area-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 400,
        colors: [GoloAdminConfig.primary, GoloAdminConfig.secondary, "#0dbe54", "#F8AA4B"],
      };
        ...
        palette: [
          {
            ...
            dark: GoloAdminConfig.secondary,
            light: "#047afb",
          },
        ],
      },
