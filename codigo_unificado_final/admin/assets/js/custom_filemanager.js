...
function openModel(modelFor) {
  ...
  if (modelFor == "newFile") {
    document.querySelector(".popup h4").innerHTML = "New File";
    let input = document.createElement("input");
    input.setAttribute("type", "text");
    input.setAttribute("placeholder", "Filename");
    let saveButton = document.createElement("button");
    saveButton.style = "background-color: #54A8FB;";
  ...
  if (modelFor == "newFolder") {
    document.querySelector(".popup h4").innerHTML = "New Folder";
    let input = document.createElement("input");
    input.setAttribute("type", "text");
  ...
  if (modelFor == "rename") {
    if (selected_item.item?.name) {
      document.querySelector(".popup h4").innerHTML = "Rename";
      let input = document.createElement("input");
      input.setAttribute("type", "text");
  ...
  if (modelFor == "delete") {
    if (selected_item.item?.name) {
      document.querySelector(".popup h4").innerHTML = "Please confirm if you would like to delete the file.";
      let saveButton = document.createElement("button");
