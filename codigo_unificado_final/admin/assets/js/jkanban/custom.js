...
(function () {
  var kanban1 = new jKanban({
    ...
    buttonClick: function (el, boardId) {
      ...
      formItem.innerHTML = '<div class="form-group"><textarea class="form-control custom-scrollbar" rows="2" autofocus></textarea></div><div class="form-group"><button type="submit" class="btn btn-primary btn-sm me-2">Submit</button><button type="button" id="CancelBtn" class="btn button-light-primary btn-sm">Cancel</button></div>';
