(function () {
    ...
    datasets: [
      {
        ...
        fillColor: "rgba(233, 247, 248, 0.4)",
        strokeColor: GoloAdminConfig.primary,
        highlightFill: "rgba(233, 247, 248, 0.6)",
        highlightStroke: GoloAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40],
      },
      {
        label: "My Second dataset",
        fillColor: "rgb(131,131,131,0.4)",
        strokeColor: GoloAdminConfig.secondary,
        highlightFill: "rgb(131,131,131,0.6)",
        highlightStroke: GoloAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: GoloAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    },
    {
      ...
      highlight: GoloAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
  ...
  var lineGraphData = {
    ...
    datasets: [
      {
        label: "My First dataset",
        fillColor: "rgba(221, 238, 254, 0.3)",
        strokeColor: GoloAdminConfig.primary,
        pointColor: GoloAdminConfig.primary,
      ...
      },
      {
        ...
        strokeColor: GoloAdminConfig.secondary,
        pointColor: GoloAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: GoloAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        strokeColor: GoloAdminConfig.primary,
        pointColor: GoloAdminConfig.primary,
        pointStrokeColor: GoloAdminConfig.primary,
        pointHighlightFill: GoloAdminConfig.primary,
        pointHighlightStroke: "rgba(233, 247 ,248, 0.4)",
        data: [12, 3, 5, 18, 7],
      },
    ],
  };
  ...
  var myLineChart = {
    ...
    datasets: [
      ...
      {
        fillColor: "rgba(221, 238, 254, 0.2)",
        strokeColor: GoloAdminConfig.primary,
        pointColor: GoloAdminConfig.primary,
