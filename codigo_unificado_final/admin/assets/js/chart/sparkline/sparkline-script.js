(function ($) {
  ...
  setTimeout(function () {
    $("#line-chart-sparkline").sparkline([5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20], {
      ...
      lineColor: GoloAdminConfig.primary,
      fillColor: "rgba(221, 238, 254, 0.40)",
      highlightLineColor: GoloAdminConfig.primary,
      highlightSpotColor: GoloAdminConfig.primary,
      targetColor: GoloAdminConfig.primary,
      performanceColor: GoloAdminConfig.primary,
      boxFillColor: GoloAdminConfig.primary,
      medianColor: GoloAdminConfig.primary,
      minSpotColor: GoloAdminConfig.primary,
    });
  });
  ...
  $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
    ...
    tooltipClassname: "chart-sparkline",
    chartRangeMax: "50",
    lineColor: GoloAdminConfig.secondary,
    fillColor: "rgb(233 247 248 / 20%)",
    highlightLineColor: "rgb(233 247 248 / 20%)",
  ...
  $("#custom-line-chart").sparkline([0, 5, 10, 7, 25, 20, 30], {
    ...
    highlightSpotColor: "rgba(221, 238, 254, 0.8)",
  });
    ...
    init: function () {
      setTimeout(function () {
        ...
        $("#bar-chart-sparkline").sparkline([5, 2, 2, 4, 9, 5, 7, 5, 2, 2, 6], {
          ...
          height: "100%",
          tooltipClassname: "chart-sparkline",
          barColor: GoloAdminConfig.primary,
        }),
        $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
          type: "pie",
          width: "400px",
          height: "100%",
          sliceColors: ["#0dbe54", "#F8AA4B", GoloAdminConfig.secondary, GoloAdminConfig.primary],
          tooltipClassname: "chart-sparkline",
        });
    },
  };
